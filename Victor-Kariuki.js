 ...
 * getX
 * 
 * Returns the larger of the values for X in a quadratic equation 
 *
 * Formulae - x = (-b +/- sqrt(b^2 - 4ac)) / 2a
 *
 * @param {Int} a - numerical coefficient
 * @param {Int} b - numerical coefficient
 * @param {Int} c - numerical coefficient
 *
 * @return {Int} x1/x2 - The larger of the two
*/
